...
import { Play, Pause, ChevronLeft, ChevronRight, Volume2, VolumeX, Maximize2, BookOpen } from 'lucide-react';
...
import slide01 from '@/assets/experience-book/slide-01.jpg';
import slide02 from '@/assets/experience-book/slide-02.jpg';
import slide03 from '@/assets/experience-book/slide-03.jpg';
import slide04 from '@/assets/experience-book/slide-04.jpg';
import slide05 from '@/assets/experience-book/slide-05.jpg';
import slide06 from '@/assets/experience-book/slide-06.jpg';
import slide07 from '@/assets/experience-book/slide-07.jpg';
import slide08 from '@/assets/experience-book/slide-08.jpg';
import slide09 from '@/assets/experience-book/slide-09.jpg';
import slide10 from '@/assets/experience-book/slide-10.jpg';
import voiceoverAudio from '@/assets/experience-book-voiceover.mp3';

const SLIDES = [slide01, slide02, slide03, slide04, slide05, slide06, slide07, slide08, slide09, slide10];

const SLIDE_TITLES = [
  'Discover Your Experience Book', 'Two Simple Purposes', 'Warm & Personal Pages',
  'Four Session Types', 'Art Sessions', 'Sensory Sessions',
  'Music & Storytelling Sessions', 'Movement Sessions', 'How Progress Works',
  'Welcome to Parent-Toddler Club',
];

export default function ExperienceBookDeck() {
  ...
  const calibration = useDeckCalibration('experience-book', totalSlides);
    ...
    <>
      <Card className="p-4 bg-gradient-to-br from-amber-500/5 to-amber-500/10 border-amber-500/20">
        <div className="flex items-center gap-2 mb-4">
          <div className="w-8 h-8 rounded-full bg-amber-500 flex items-center justify-center"><BookOpen className="w-4 h-4 text-white" /></div>
          <div><h3 className="font-semibold text-foreground">The Experience Book</h3><p className="text-xs text-muted-foreground">Interactive presentation with voiceover</p></div>
        </div>
